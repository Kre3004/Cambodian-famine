...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-3xl mx-auto mb-16">
            <p>
              ...
              1.7 to 2 million Cambodians, representing approximately 25% of the country's population. While often
              described as a tragic consequence of failed agricultural reform, the Cambodian famine was far more
              insidious. It was a deliberate tool of political control and extermination—engineered by the Khmer Rouge
              to discipline, punish, and eliminate those deemed enemies of the regime. This weaponization of famine
              aligns with political theorist Achille Mbembe's concept of necropolitics: the power to determine who may
      ...
      <section id="testimonies" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <h3 className="text-2xl font-bold text-center mb-8">VIDEO TESTIMONY: CHUM MEY</h3>

            <div className="relative w-full pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/6MCpAkSNjRs?si=QZo2-i2wpd6YiYHW"
            ...
            <p className="text-gray-700 mt-4 italic">
              In this powerful survivor testimony, Chum Mey, one of the few survivors of the Khmer Rouge's notorious
              Tuol Sleng prison (S-21), recounts his harrowing experiences during the Cambodian genocide. Speaking to
              AFP News Agency, Chum Mey reflects on the brutal torture, forced confessions, and the enduring trauma that
              he and thousands of others endured under the Khmer Rouge regime. His personal story is a poignant reminder
              of the atrocities that took place at S-21 and the resilience of those who survived.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Necropolitics Theory Section */}
      <section id="necropolitics" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">FAMINE AND NECROPOLITICS</h2>

          <div className="prose prose-lg max-w-3xl mx-auto">
            <p>
              Famine in Cambodia did not begin or end with the Khmer Rouge. The country's vulnerability to food
              insecurity stretches back decades, shaped by colonial extraction, Cold War geopolitics, U.S. bombing
              campaigns, and civil war. Hardship and malnutrition were already widespread before 1975—and they continued
              well after the Khmer Rouge fell in 1979, as Cambodia struggled under Vietnamese occupation, a collapsed
              economy, and international isolation.
            </p>

            <p>
              However, as famine scholar Alex de Waal argues in{" "}
              <em>Mass Starvation: The History and Future of Famine</em>, there is a crucial distinction between
              vulnerability and atrocity. De Waal introduces the concept of "faminogenic acts"—policies or actions by
              governments that actively generate famine conditions. In this light, the famine under the Khmer Rouge was
              not simply a tragic byproduct of poor planning or structural collapse. It was a politically driven
              catastrophe. The regime used starvation as a weapon to enforce ideological purity, discipline laborers,
              and eliminate dissent. The denial of food, healthcare, and rest became a tool of political control.
            </p>

            <p>
              To deepen this analysis, we can turn to Achille Mbembe's theory of necropolitics, which describes how
              modern regimes exercise power through control over death and survival.
            </p>

            <blockquote className="italic border-l-4 border-red-600 pl-4 py-2 my-6">
              "The ultimate expression of sovereignty largely resides in the power and capacity to dictate who is able
              to live and who must die... To be sovereign is to exert one's control over mortality and to define life as
              the deployment and manifestation of power."
              <footer className="text-right mt-2">
                — Achille Mbembe, <cite>Necropolitics</cite>
              </footer>
            </blockquote>

            <p>
              Under the Khmer Rouge, existence itself was contingent upon loyalty and productivity. Those deemed
              unworthy—intellectuals, minorities, the sick, the elderly, or simply the disobedient—were starved,
              neglected, or executed. The regime didn't just fail to prevent famine; it actively used famine as a method
              of annihilation. In this sense, famine became an instrument of necropolitics: not just mass suffering, but
              mass death administered by political design.
            </p>

            <h3 className="text-2xl font-bold mt-10 mb-4">A GLOBAL PATTERN OF FAMINE</h3>

            <p>
              The Cambodian famine, while extreme in its brutality, was not an isolated event. According to famine
              scholar Alex de Waal in his book <em>Mass Starvation</em>, most modern famines are not caused by natural
              disasters or food shortages, but by political violence, authoritarian rule, and policy decisions that
              create or worsen crisis conditions.
            </p>

            <p>
              De Waal identifies these as "faminogenic acts"—deliberate or negligent choices by governments and armed
              groups that lead to starvation. He emphasizes that famines today are often the result of armed conflict,
              forced displacement, destruction of healthcare systems, and repression of dissent, rather than
              environmental scarcity.
            </p>

            <p>
              In Cambodia, the Khmer Rouge deliberately collectivized agriculture, banned private food preparation, and
              withheld rations as a form of punishment. But similar patterns have occurred elsewhere—in Ethiopia, Sudan,
              and North Korea—where authoritarian regimes used starvation as a political weapon.
            </p>

            <p>
              Understanding famine as a man-made phenomenon helps situate the Cambodian case within a larger global
              narrative: one where famine is not merely a humanitarian tragedy, but a form of governance through death.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Legacy Section */}
      <section id="aftermath" className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
